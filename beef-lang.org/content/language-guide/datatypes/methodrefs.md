...
## Function pointers
Function pointer types can point to static methods, external functions, or functions dynamically generated by libraries. Function pointers are generated with the `=>` operator.
```C#
